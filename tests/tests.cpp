...
using and_flags = mf::and_t_<mf::one_of_<Read, Write>, mf::one_of_<Cached, NonCached>>;

using or_flags = mf::or_t_<mf::one_of_<Read, Write>, mf::one_of_<Cached>>;

using optional_flags = mf::and_t_<mf::one_of_<Read, Write>, mf::optional_t_<mf::one_of_<Cached, NonCached>>>;
